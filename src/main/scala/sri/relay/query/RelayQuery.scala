...
import sri.relay.query.RelayQuery.{
  ConcreteQueryObject,
  FragmentNames,
  NextChildren
}
...
@js.native
@JSImport("RelayQuery", JSImport.Namespace)
object RelayQuery extends js.Object {
  ...
  def buildFragment(
      ...
      tpe: String,
      children: js.UndefOr[Seq[RelayQueryNode]],
      metadata: js.UndefOr[js.Dictionary[js.Any]]): RelayQueryFragment =
    js.native
  ...
  def buildMutation(
      ...
      callName: String,
      children: js.UndefOr[Seq[RelayQueryNode]],
      metadata: js.UndefOr[js.Dictionary[js.Any]]): RelayQueryMutation =
    js.native
...
trait RelayQueryNode extends js.Object {
  ...
  def getFieldByStorageKey(storageKey: String): js.UndefOr[RelayQueryField] =
    js.native
  ...
  def getConcreteQueryNode(
      onCacheMiss: () => ConcreteQueryObject): ConcreteQueryObject = js.native
}

@js.native
@JSImport("RelayQueryRoot", JSImport.Default)
class RelayQueryRoot(concreteNode: ConcreteQueryObject,
                     route: RelayMetaRoute,
                     variables: Variables)
...
@js.native
@JSImport("RelayQueryOperation", JSImport.Default)
class RelayQueryOperation(concreteNode: ConcreteQueryObject,
                          route: RelayMetaRoute,
                          variables: Variables)
    extends RelayQueryNode {
...
/**
  ...
  */
@js.native
@JSImport("RelayQueryFragment", JSImport.Default)
...
/**
  ...
  */
@js.native
@JSImport("RelayQueryField", JSImport.Default)
class RelayQueryField(concreteNode: ConcreteQueryObject,
                      route: RelayMetaRoute,
                      variables: Variables)
    extends RelayQueryNode {
  ...
  def cloneFieldWithCalls(children: NextChildren,
                          calls: Seq[Call]): js.UndefOr[RelayQueryField] =
    js.native
