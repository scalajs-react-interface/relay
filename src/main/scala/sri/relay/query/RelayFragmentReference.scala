...
/**
  ...
  */
@js.native
@JSImport("RelayFragmentReference", JSImport.Default)
class RelayFragmentReference(fragmentGetter: FragmentGetter,
  ...
  /**
    ...
    */
  def getFragment(variables: Variables): js.UndefOr[js.Object] =
    js.native
  ...
  /**
    ...
    */
  def getVariables(route: RelayMetaRoute, variables: Variables): Variables =
    js.native
