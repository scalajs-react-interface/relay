...
@js.native
@JSImport("RelayMutationTransaction", JSImport.Namespace)
...
@js.native
@JSImport("RelayMutationTransaction", JSImport.Default)
class RelayMutationTransaction(mutation: RelayMutation) extends js.Object {

  def commit(
      callbacks: js.UndefOr[RelayMutationTransactionCommitCallbacks]): Unit =
    js.native
