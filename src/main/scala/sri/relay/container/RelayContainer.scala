...
import sri.relay.{RelayClass, RelayComponent, RelayComponentProps}
...
import sri.relay.tools.RelayTypes.{
...
object RootQueries {
  def apply(queries: (String, QueryBuilder)*): RootQueries =
    queries.toMap.toJSDictionary
}

object Fragments {
  def apply(fragments: (String, Fragment)*): Fragments =
    fragments.toMap.toJSDictionary
}
...
trait RelayContainer[C <: RelayClass] extends ComponentConstructor {
  ...
  def setVariables(partialVariables: js.UndefOr[Variables] = js.undefined,
                   callback: js.UndefOr[ComponentReadyStateChangeCallback] =
  ...
  def componentWillReceiveProps(nextProps: js.Object,
                                nextContext: js.Object = ???): Unit = js.native

  def shouldComponentUpdate(nextProps: js.Object,
                            nextState: js.Any,
                            nextContext: js.Any): Boolean = js.native
